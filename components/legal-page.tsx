...
function Terms({ ar }: { ar: boolean }) {
  if (ar) {
    return (
      <>
        ...
        <h2>ما تقرأه</h2>
        <p>صفحة المجالات تصف مساحات استكشاف، لا مشروعات مُسلَّمة، إلا إذا قال اتفاق مكتوب غير ذلك. صفحة الإحاطة مستشعر: إشارات وإحاطات للمساعدة على الرؤية، لا نصيحة قانونية أو استثمارية أو قرارًا حكوميًا بالنيابة عنك.</p>
  ...
  return (
    <>
      ...
      <p>The fields page describes areas of exploration, not delivered projects, unless a written agreement says otherwise. The Brief page is a sensor: signals and briefings to help you see, not legal, investment, or policy advice, and not a decision made for you.</p>
